...
digunakan. Yakni index.php/admin/products/edit/ID --->
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('nama_kelas') ? 'is-invalid' : '' ?>" type="text" name="nama_kelas" placeholder="nama_kelas" value="<?php echo $daftarkelas->nama_kelas ?>" />
